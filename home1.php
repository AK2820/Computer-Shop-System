...
<body>
  ...
  <div class="color1">
    <ul class="nav nav-tabs" >
      ...
      <li role="presentation"><a href="showexpenses.php" id="lic3" >Expenses Detail</a></li>
    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <br>
        <footer class="color1" style="color:#FEBD69;">
            <h3 style="text-align:center; padding-top:2%; font-family:serif; font-weight:bold;">Copyright &copy; Aniket Kank</h3>
