...
<html>
  ...
  <body>
    ...
    <div class="col-md-6 ">
      ...
      <br>
        <span class="Newabout" >E-ID</span>

          <div class="input-group">
              <span class="input-group-addon" style="border-radius:0; font-size:20px;"/>ID</span>
              <span class="input-group-addon" style="border-radius:0; background-color:lightgray;font-family:serif; font-size:22px;"/></span>
          </div>
          <br>
